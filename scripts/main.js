...
function displayCardsDynamically(collection) {
    ...
    db.collection(collection).orderBy("hike_time").limit(3).get()  //the collection called "hikes"
        .then(allHikes=> {
...
function updateBookmarks(hikeDocID) {
    currentUser.get().then(doc => {
        console.log(doc.data().bookmarks);
        let currentBookmark = doc.data().bookmarks;

        if (currentBookmark && currentBookmark.includes(hikeDocID)) {
